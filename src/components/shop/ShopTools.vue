  ...
  <div id="shoptools">
    ...
    <div class="mall-tools">
      ...
      <div class="mall-tools-list">
        <ul>
          <li v-for="(item,index) in tools_list" ref="thisli" :data-name="item.product_name" :key="item.id" :data-index="index" :data-gameId="item.game_id" :data-price="item.cprice" :data-quality="item.quality" :data-icon="item.game_id" >
...
//        })
      ...
      toggleCase:function(event){
        ...
        let _price =this.thousandBitSeparator(parseInt(el.getAttribute('data-price')));
        this.$refs.productnum.innerHTML=_price+' C';

<template>
  ...
  <div class="item-cols-num clearfix">
    <div class="select">
      ...
      <span class="num">
        <input type="text"
               :class="{show:show}"  v-model="Num>=limit?limit:Num"
               @blur="blur()"
               :maxlength="maxLength">
                  <ul ref="ul">
...
<style lang="scss" scoped>
  ...
  .select {
    ...
    .down {
      background: url(../../assets/images/Mall-images/sub.png) no-repeat;
    }
    ...
    .up {
      margin: 0;
      background: url(../../assets/images/Mall-images/add.png) no-repeat center center;
    }
  }
  .down.down-disabled {
    cursor: not-allowed;

<template>
  <div id="userinfo">
    <div class="modify_bg">
      <div class="modify-seat">您的位置： <router-link to="./personinfo" tag="i">我的菜园</router-link> 》 <router-link to="./personinfo" tag="i">个人信息</router-link> 》 <span class="cl-yellow1">手机号修改</span></div>
    ...
    methods:{
      ...
      getUersInfo:function(){
        ...
        Http.get('/self','').then(function(data){
          if(data.data.code==0){
            _this.$refs.uersInfo.innerHTML=data.data.data.mobile;
          }
        })
      },
      doSave:function(){
